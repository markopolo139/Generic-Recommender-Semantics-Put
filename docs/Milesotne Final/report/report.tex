...
Please refer to \textbf{Appendix A} (Figure \ref{fig:inference}) for the complete inference diagram.
...
\begin{figure}[H]
    \centering
    % Placeholder for the system inference diagram
    \includegraphics[width=1.0\linewidth, height=0.9\textheight, keepaspectratio]{inference_diagram.png} 
    \caption{Generic Recommender System Workflow: Recommendation Inference}
    \label{fig:inference}
\end{figure}
